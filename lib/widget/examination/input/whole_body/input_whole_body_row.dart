...
class InputWholeBodyRow extends StatefulWidget {
  final DataWholeBody input;
  final ResultWholeBody? result;

  const InputWholeBodyRow({super.key, required this.input, this.result});

  @override
  State<InputWholeBodyRow> createState() => _InputWholeBodyRowState();
}

class _InputWholeBodyRowState extends State<InputWholeBodyRow> {
    ...
    return widget.result == null
        ...
        : Column(
            children: [
              ...
              _keyValue(
                key: "Rerata",
                value: widget.result!.average.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
              _keyValue(
                key: "Standar Deviasi",
                value: widget.result!.standarDeviasi.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
              _keyValue(
                key: "U Presisi",
                value: widget.result!.upresisi.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
              _keyValue(
                key: "U Kalibrasi",
                value: widget.result!.ukalibrasi.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
              _keyValue(
                key: "U Gabungan",
                value: widget.result!.ugabungan.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
              _keyValue(
                key: "U95%",
                value: widget.result!.u95.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
              _keyValue(
                key: "Laporan m/s2",
                value: widget.result!.laporanMSrerata.toStringAsFixed(2),
                valueColor: Colors.black,
              ),
            ],
          );
      ...
      dataRows = [
        DataRow2(
          cells: [
            ...
            DataCell(Text(widget.result!.resultanMM1.toStringAsFixed(2), style: bodyStyle)),
          ],
        ),
        DataRow2(
          cells: [
            ...
            DataCell(Text(widget.result!.resultanMM2.toStringAsFixed(2), style: bodyStyle)),
          ],
        ),
        DataRow2(
          cells: [
            ...
            DataCell(Text(widget.result!.resultanMM3.toStringAsFixed(2), style: bodyStyle)),
          ],
        ),
      ];
      ...
      return SizedBox(
        ...
        child: DataTable2(
          ...
          columns: const [
            ...
            DataColumn2(
              numeric: true,
              label: Text('Sumbu X(mm/s)'),
              size: ColumnSize.M,
            ),
            DataColumn2(
              numeric: true,
              label: Text('Sumbu Y(mm/s)'),
              size: ColumnSize.M,
            ),
            DataColumn2(
              numeric: true,
              label: Text('Sumbu Z(mm/s)'),
              size: ColumnSize.M,
            ),
          ],
          rows: dataRows,
    ...
    return CustomCard(
      ...
      child: ExpansionTile(
        ...
        children: [
          ...
          _keyValue(
            key: "Posisi Pengukuran",
            value: widget.input.posisiPengukuran.label,
            valueColor: Colors.black,
          ),
          _keyValue(
            key: "Sumber Getaran",
          ...
          _keyValue(
            key: "Durasi Paparan",
            value: "${widget.input.durasiPaparanStart} - ${widget.input.durasiPaparanEnd} Jam",
            valueColor: Colors.black,
          ),
          _keyValue(
            key: "Note",
