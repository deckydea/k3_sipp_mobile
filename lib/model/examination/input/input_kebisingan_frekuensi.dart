...
class DataKebisinganFrekuensi extends Equatable {
  ...
  factory DataKebisinganFrekuensi.fromJson(Map<String, dynamic> json) {
    return DataKebisinganFrekuensi(
      ...
      value1: double.parse(json['value1']),
      value2: double.parse(json['value2']),
      value3: double.parse(json['value3']),
      value4: double.parse(json['value4']),
      value5: double.parse(json['value5']),
      value6: double.parse(json['value6']),
      value7: double.parse(json['value7']),
      value8: double.parse(json['value8']),
      value9: double.parse(json['value9']),
      value10: double.parse(json['value10']),
      note: json['note'],
