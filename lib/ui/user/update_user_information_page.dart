...
import 'package:k3_sipp_mobile/logic/user/update_user_information_logic.dart';
...
class UpdateUserInformationPage extends StatefulWidget {
  ...
  const UpdateUserInformationPage({super.key, this.user});

  @override
  State<UpdateUserInformationPage> createState() => _UpdateUserInformationPageState();
}
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Informasi Profile", style: Theme.of(context).textTheme.headlineLarge),
      ),
      body: _buildBody(),
    );
  }
