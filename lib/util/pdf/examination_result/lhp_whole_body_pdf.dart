...
class LHPWholeBodyPdf {
  ...
  static Widget _buildAnalisis(Examination examination) {
    List<ResultWholeBody> results = examination.examinationResult;

    ResultWholeBody? highResult;
    ResultWholeBody? lowResult;
    for (ResultWholeBody result in results) {
  ...
  static Widget _buildKesimpulan(Examination examination) {
    List<ResultWholeBody> highNAB = [];
    List<ResultWholeBody> lowNAB = [];
